...
SOURCES: tuple[SourceConfig, ...] = (
    ...
    # Explicit anchor for Topic.FINANCIAL_AID_COSTS (Source Manifest V2 migration) -- same
    # "every topic needs at least one manually-curated source" reasoning as ACADEMICS's anchor
    # in registration_records.py.
    SourceConfig(
        url="https://registrar.illinois.edu/tuition-fees/tuition-fee-rates",
        department="Office of the Registrar",
        topic=Topic.FINANCIAL_AID_COSTS,
        source_type=SourceType.HTML,
        fallback_title="Tuition & Fee Rates",
    ),
)
